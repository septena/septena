...
const FALLBACK: AppConfig = {
  ...
  // If the data folder really is missing, the real response corrects this.
  data_exists: true,
...
/** Resolved server config (data folder path, integration availability, section
